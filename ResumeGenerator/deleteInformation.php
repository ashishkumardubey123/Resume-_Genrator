...
if(isset($_GET['delete'])){
    $id=$_GET['delete'];
    $sql="UPDATE resumes SET status=0 WHERE id=$id";
    if(mysqli_query($conn,$sql)){
      header("Location: deleteInformation.php?page=1");
    }
}
$results_per_page = 5;
if (!isset($_GET['page'])) {
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav me-auto ">
        ...
        <li class="nav-item">
            <a class="active btn btn-outline-danger fw-b" href="./deleteInformation.php?page=1">Delete Information</a>
        </li>
      </ul>
      <ul class="navbar-nav">
        <li class="nav-item">
...
<h1 class="text-center bg-warning fw-b my-3">Delete Information</h1>
                    ...
                    <tbody>
                        ...
                        <?php while($resumes = mysqli_fetch_assoc($result)): ?>
                            <tr>
                                ...
                                <td class='text-center my-3 justify-content-center align-items-center d-flex'><a href='./deleteInformation.php?delete=<?php echo $resumes['id']; ?>' class='btn btn-danger mx-1'><i class='fa-solid fa-trash'></i></a></td>
                            </tr>
                            <?php $number++; ?>
                        <?php endwhile; ?>
                    </tbody>
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-center">
                <?php for ($page=1; $page<=$total_pages; $page++): ?>
                    <li class="page-item <?php if ($page == $_GET['page']) echo 'active'; ?>"><a class="page-link" href="deleteInformation.php?page=<?php echo $page; ?>"><?php echo $page; ?></a></li>
                <?php endfor; ?>
            </ul>
        </nav>
    </div>
